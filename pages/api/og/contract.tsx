          ...
          <div tw="flex flex-row w-full">
            ...
            <div tw="flex flex-col max-w-4xl">
              ...
              {contractData.description && (
                <p tw="font-medium text-2xl text-opacity-90 text-white">
                  {descriptionShortener(contractData.description)}
                </p>
              )}
            </div>
          </div>
          <div tw="flex justify-between w-full items-end">
            ...
            >
              {contractData.erc && (
                <>
                  <PackageIcon />
                  <span tw="ml-4">{contractData.erc}</span>
                </>
              )}
            </div>
