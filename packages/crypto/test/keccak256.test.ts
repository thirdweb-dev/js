import { keccak256SyncHex, keccak256Sync } from "../src";
...
describe("keccak256", () => {
  it("keccak256SyncHex === ethers.utils.keccak256", async () => {
  ...
  it("keccak256SyncHex === @noble/hashes: keccak_256 -> hex", async () => {
    const out = keccak256SyncHex(STRING_TO_HASH);
    const nobleOut = "0x" + uint8ArrayToHex(keccak_256(STRING_TO_HASH));
