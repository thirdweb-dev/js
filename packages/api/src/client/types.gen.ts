...
export type GetV1ContractsData = {
	body?: never;
	path?: never;
	query?: {
		/**
...
export type GetV1ContractsErrors = {
	/**
...
export type GetV1ContractsResponses = {
	/**
...
export type GetV1ContractsResponse =
	GetV1ContractsResponses[keyof GetV1ContractsResponses];

export type PostV1ContractsData = {
	body?: {
		/**
...
export type PostV1ContractsErrors = {
	/**
	 * Invalid request parameters
	 */
	400: unknown;
...
export type PostV1ContractsResponses = {
	/**
...
export type PostV1ContractsResponse =
	PostV1ContractsResponses[keyof PostV1ContractsResponses];
...
export type SendOtpResponse = SendOtpResponses[keyof SendOtpResponses];
...
export type GetV1WalletsErrors = {
	/**
	 * Authentication required. The request must include a valid `x-secret-key` header for backend authentication.
	 */
	401: unknown;
...
export type GetV1WalletsResponses = {
	/**
...
export type GetV1WalletsResponse =
	GetV1WalletsResponses[keyof GetV1WalletsResponses];
