...
import type {
	...
	GetV1ContractsData,
	GetV1ContractsErrors,
	GetV1ContractsResponses,
	GetV1WalletsData,
	GetV1WalletsErrors,
	GetV1WalletsResponses,
 ...
 */
export const getV1Contracts = <ThrowOnError extends boolean = false>(
	options?: Options<GetV1ContractsData, ThrowOnError>,
) => {
 ...
 * **Authentication**: This endpoint requires backend authentication using the `x-secret-key` header. The secret key should never be exposed publicly.
 */
export const postV1Contracts = <ThrowOnError extends boolean = false>(
	options?: Options<PostV1ContractsData, ThrowOnError>,
) => {
 ...
 */
export const sendOtp = <ThrowOnError extends boolean = false>(
	options?: Options<SendOtpData, ThrowOnError>,
) => {
	return (options?.client ?? _heyApiClient).post<
		SendOtpResponses,
		SendOtpErrors,
...
/**
 * Verify OTP
 * Verify OTP for login authentication
 */
 ...
 * **Authentication**: This endpoint requires backend authentication using the `x-secret-key` header. The secret key should never be exposed publicly.
 */
export const getV1Wallets = <ThrowOnError extends boolean = false>(
	options?: Options<GetV1WalletsData, ThrowOnError>,
) => {
	return (options?.client ?? _heyApiClient).get<
		GetV1WalletsResponses,
		GetV1WalletsErrors,
