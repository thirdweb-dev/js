 ...
 * @example
 * ```ts
 * import { isContractURISupported } from "thirdweb/extensions/airdrop";
 *
 ...
 * @example
 * ```ts
 * import { decodeContractURIResult } from "thirdweb/extensions/airdrop";
 ...
 * @example
 * ```ts
 * import { contractURI } from "thirdweb/extensions/airdrop";
 *
