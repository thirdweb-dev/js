 ...
 * @example
 * ```ts
 * import { isSetContractURISupported } from "thirdweb/extensions/airdrop";
 *
 ...
 * @example
 * ```ts
 * import { encodeSetContractURIParams } "thirdweb/extensions/airdrop";
 ...
 * @example
 * ```ts
 * import { encodeSetContractURI } "thirdweb/extensions/airdrop";
 ...
 * @example
 * ```ts
 * import { setContractURI } from "thirdweb/extensions/airdrop";
 *
