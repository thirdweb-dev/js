 ...
 * @example
 * ```ts
 * import { isGetTokenCountOfBundleSupported } from "thirdweb/extensions/erc1155";
 ...
 * @example
 * ```ts
 * import { encodeGetTokenCountOfBundleParams } from "thirdweb/extensions/erc1155";
 ...
 * @example
 * ```ts
 * import { encodeGetTokenCountOfBundle } from "thirdweb/extensions/erc1155";
 ...
 * @example
 * ```ts
 * import { decodeGetTokenCountOfBundleResult } from "thirdweb/extensions/erc1155";
 ...
 * @example
 * ```ts
 * import { getTokenCountOfBundle } from "thirdweb/extensions/erc1155";
 *
