 ...
 * @example
 * ```ts
 * import { isGetImplementationSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeGetImplementationParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeGetImplementation } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeGetImplementationResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { getImplementation } from "thirdweb/extensions/assets";
 *
