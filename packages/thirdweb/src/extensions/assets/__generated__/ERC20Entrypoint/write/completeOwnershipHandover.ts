 ...
 * @example
 * ```ts
 * import { isCompleteOwnershipHandoverSupported } from "thirdweb/extensions/assets";
 *
 ...
 * @example
 * ```ts
 * import { encodeCompleteOwnershipHandoverParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeCompleteOwnershipHandover } from "thirdweb/extensions/assets";
 ...
 * import { completeOwnershipHandover } from "thirdweb/extensions/assets";
 *
