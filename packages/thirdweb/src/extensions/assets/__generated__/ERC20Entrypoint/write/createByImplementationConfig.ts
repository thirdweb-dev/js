 ...
 * @example
 * ```ts
 * import { isCreateByImplementationConfigSupported } from "thirdweb/extensions/assets";
 *
 ...
 * @example
 * ```ts
 * import { encodeCreateByImplementationConfigParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeCreateByImplementationConfig } from "thirdweb/extensions/assets";
 ...
 * import { createByImplementationConfig } from "thirdweb/extensions/assets";
 *
