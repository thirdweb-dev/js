 ...
 * @example
 * ```ts
 * import { isBuySupported } from "thirdweb/extensions/assets";
 *
 ...
 * @example
 * ```ts
 * import { encodeBuyParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeBuy } from "thirdweb/extensions/assets";
 ...
 * import { buy } from "thirdweb/extensions/assets";
 *
