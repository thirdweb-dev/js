 ...
 * @example
 * ```ts
 * import { isGetAirdropSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeGetAirdropResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { getAirdrop } from "thirdweb/extensions/assets";
 *
