 ...
 * @example
 * ```ts
 * import { isProxiableUUIDSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeProxiableUUIDResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { proxiableUUID } from "thirdweb/extensions/assets";
 *
