 ...
 * @example
 * ```ts
 * import { isPredictAddressByConfigSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodePredictAddressByConfigParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodePredictAddressByConfig } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodePredictAddressByConfigResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { predictAddressByConfig } from "thirdweb/extensions/assets";
 *
