 ...
 * @example
 * ```ts
 * import { isGuardSaltSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeGuardSaltParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeGuardSalt } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeGuardSaltResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { guardSalt } from "thirdweb/extensions/assets";
 *
