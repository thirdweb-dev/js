 ...
 * @example
 * ```ts
 * import { isOwnershipHandoverExpiresAtSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeOwnershipHandoverExpiresAtParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeOwnershipHandoverExpiresAt } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeOwnershipHandoverExpiresAtResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { ownershipHandoverExpiresAt } from "thirdweb/extensions/assets";
 *
