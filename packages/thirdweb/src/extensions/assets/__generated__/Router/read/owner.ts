 ...
 * @example
 * ```ts
 * import { isOwnerSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeOwnerResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { owner } from "thirdweb/extensions/assets";
 *
