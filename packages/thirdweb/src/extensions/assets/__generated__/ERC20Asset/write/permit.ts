 ...
 * @example
 * ```ts
 * import { isPermitSupported } from "thirdweb/extensions/assets";
 *
 ...
 * @example
 * ```ts
 * import { encodePermitParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodePermit } from "thirdweb/extensions/assets";
 ...
 * import { permit } from "thirdweb/extensions/assets";
 *
