 ...
 * @example
 * ```ts
 * import { isBurnFromSupported } from "thirdweb/extensions/assets";
 *
 ...
 * @example
 * ```ts
 * import { encodeBurnFromParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeBurnFrom } from "thirdweb/extensions/assets";
 ...
 * import { burnFrom } from "thirdweb/extensions/assets";
 *
...
export function burnFrom(
  ...
  return prepareContractCall({
    ...
    params: async () => {
      ...
      return [resolvedOptions.from, resolvedOptions.amount] as const;
    },
