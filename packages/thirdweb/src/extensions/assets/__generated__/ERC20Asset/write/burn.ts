 ...
 * @example
 * ```ts
 * import { isBurnSupported } from "thirdweb/extensions/assets";
 *
 ...
 * @example
 * ```ts
 * import { encodeBurnParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeBurn } from "thirdweb/extensions/assets";
 ...
 * import { burn } from "thirdweb/extensions/assets";
 *
