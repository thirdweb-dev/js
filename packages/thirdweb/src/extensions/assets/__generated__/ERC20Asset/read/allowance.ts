 ...
 * @example
 * ```ts
 * import { isAllowanceSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeAllowanceParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeAllowance } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeAllowanceResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { allowance } from "thirdweb/extensions/assets";
 *
