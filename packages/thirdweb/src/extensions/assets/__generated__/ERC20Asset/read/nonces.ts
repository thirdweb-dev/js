 ...
 * @example
 * ```ts
 * import { isNoncesSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeNoncesParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeNonces } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeNoncesResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { nonces } from "thirdweb/extensions/assets";
 *
