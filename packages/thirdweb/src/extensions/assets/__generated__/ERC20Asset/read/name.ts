 ...
 * @example
 * ```ts
 * import { isNameSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeNameResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { name } from "thirdweb/extensions/assets";
 *
