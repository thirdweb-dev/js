 ...
 * @example
 * ```ts
 * import { isDecimalsSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeDecimalsResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decimals } from "thirdweb/extensions/assets";
 *
