 ...
 * @example
 * ```ts
 * import { isBalanceOfSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeBalanceOfParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeBalanceOf } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeBalanceOfResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { balanceOf } from "thirdweb/extensions/assets";
 *
