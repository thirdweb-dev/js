 ...
 * @example
 * ```ts
 * import { isSymbolSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeSymbolResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { symbol } from "thirdweb/extensions/assets";
 *
