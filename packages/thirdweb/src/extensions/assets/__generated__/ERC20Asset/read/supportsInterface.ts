 ...
 * @example
 * ```ts
 * import { isSupportsInterfaceSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeSupportsInterfaceParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeSupportsInterface } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeSupportsInterfaceResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { supportsInterface } from "thirdweb/extensions/assets";
 *
