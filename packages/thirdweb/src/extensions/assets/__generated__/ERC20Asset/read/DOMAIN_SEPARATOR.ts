 ...
 * @example
 * ```ts
 * import { isDOMAIN_SEPARATORSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeDOMAIN_SEPARATORResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { DOMAIN_SEPARATOR } from "thirdweb/extensions/assets";
 *
