 ...
 * @example
 * ```ts
 * import { isContractURISupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeContractURIResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { contractURI } from "thirdweb/extensions/assets";
 *
