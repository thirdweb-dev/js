 ...
 * @example
 * ```ts
 * import { isTotalSupplySupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeTotalSupplyResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { totalSupply } from "thirdweb/extensions/assets";
 *
