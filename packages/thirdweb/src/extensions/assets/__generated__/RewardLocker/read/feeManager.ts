 ...
 * @example
 * ```ts
 * import { isFeeManagerSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeFeeManagerResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { feeManager } from "thirdweb/extensions/assets";
 *
