 ...
 * @example
 * ```ts
 * import { isUsedNoncesSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeUsedNoncesParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeUsedNonces } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeUsedNoncesResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { usedNonces } from "thirdweb/extensions/assets";
 *
