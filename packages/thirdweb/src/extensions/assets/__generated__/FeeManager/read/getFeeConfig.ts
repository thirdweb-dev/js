 ...
 * @example
 * ```ts
 * import { isGetFeeConfigSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeGetFeeConfigParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeGetFeeConfig } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeGetFeeConfigResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { getFeeConfig } from "thirdweb/extensions/assets";
 *
