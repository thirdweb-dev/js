 ...
 * @example
 * ```ts
 * import { isRolesOfSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeRolesOfParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeRolesOf } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeRolesOfResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { rolesOf } from "thirdweb/extensions/assets";
 *
