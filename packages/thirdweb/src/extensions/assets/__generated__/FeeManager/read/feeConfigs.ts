 ...
 * @example
 * ```ts
 * import { isFeeConfigsSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeFeeConfigsParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeFeeConfigs } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeFeeConfigsResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { feeConfigs } from "thirdweb/extensions/assets";
 *
