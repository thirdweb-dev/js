 ...
 * @example
 * ```ts
 * import { isHasAllRolesSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeHasAllRolesParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeHasAllRoles } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeHasAllRolesResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { hasAllRoles } from "thirdweb/extensions/assets";
 *
