 ...
 * @example
 * ```ts
 * import { isDomainSeparatorSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeDomainSeparatorResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { domainSeparator } from "thirdweb/extensions/assets";
 *
