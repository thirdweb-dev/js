 ...
 * @example
 * ```ts
 * import { isHasAnyRoleSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeHasAnyRoleParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeHasAnyRole } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeHasAnyRoleResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { hasAnyRole } from "thirdweb/extensions/assets";
 *
