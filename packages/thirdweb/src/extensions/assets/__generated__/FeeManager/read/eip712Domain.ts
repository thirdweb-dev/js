 ...
 * @example
 * ```ts
 * import { isEip712DomainSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeEip712DomainResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { eip712Domain } from "thirdweb/extensions/assets";
 *
