 ...
 * @example
 * ```ts
 * import { isCalculateFeeSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeCalculateFeeParams } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { encodeCalculateFee } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeCalculateFeeResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { calculateFee } from "thirdweb/extensions/assets";
 *
