 ...
 * @example
 * ```ts
 * import { isROLE_FEE_MANAGERSupported } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { decodeROLE_FEE_MANAGERResult } from "thirdweb/extensions/assets";
 ...
 * @example
 * ```ts
 * import { ROLE_FEE_MANAGER } from "thirdweb/extensions/assets";
 *
