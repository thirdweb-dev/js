...
export const FN_SELECTOR = "0x9ba861e3" as const;
const FN_INPUTS = [
  {
    type: "address",
    name: "target",
 ...
 * @example
 * ```ts
 * import { isSetFeeConfigBySignatureSupported } from "thirdweb/extensions/assets";
 *
 * const supported = isSetFeeConfigBySignatureSupported(["0x..."]);
 * ```
 */
export function isSetFeeConfigBySignatureSupported(
 ...
 * @example
 * ```ts
 * import { encodeSetFeeConfigBySignatureParams } from "thirdweb/extensions/assets";
 ...
 * ```
 */
export function encodeSetFeeConfigBySignatureParams(
  options: SetFeeConfigBySignatureParams,
) {
 ...
 * @example
 * ```ts
 * import { encodeSetFeeConfigBySignature } from "thirdweb/extensions/assets";
 ...
 * ```
 */
export function encodeSetFeeConfigBySignature(
  options: SetFeeConfigBySignatureParams,
) {
  // we do a "manual" concat here to avoid the overhead of the "concatHex" function
  // we can do this because we know the specific formats of the values
  return (FN_SELECTOR +
    encodeSetFeeConfigBySignatureParams(options).slice(
      2,
 ...
 * import { setFeeConfigBySignature } from "thirdweb/extensions/assets";
 *
 ...
 * ```
 */
export function setFeeConfigBySignature(
  options: BaseTransactionOptions<
    | SetFeeConfigBySignatureParams
    | {
