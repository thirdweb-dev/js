 ...
 *
 * const supported = SimpleMetadataERC1155.isSetTokenURISupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { SimpleMetadataERC1155 } from "thirdweb/modules";
 * const result = SimpleMetadataERC1155.encodeSetTokenURIParams({
 *  id: ...,
 *  uri: ...,
 * });
 * ```
 ...
 * ```ts
 * import { SimpleMetadataERC1155 } from "thirdweb/modules";
 * const result = SimpleMetadataERC1155.encodeSetTokenURI({
 *  id: ...,
 *  uri: ...,
 * });
 * ```
 ...
 * import { SimpleMetadataERC1155 } from "thirdweb/modules";
 *
 * const transaction = SimpleMetadataERC1155.setTokenURI({
 *  contract,
 *  id: ...,
 *  uri: ...,
 *  overrides: {
