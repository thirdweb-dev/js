 ...
 * const supported = SimpleMetadataERC1155.isEncodeBytesOnInstallSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { SimpleMetadataERC1155 } from "thirdweb/modules";
 * const result = SimpleMetadataERC1155.decodeEncodeBytesOnInstallResultResult("...");
 * ```
 */
 ...
 * import { SimpleMetadataERC1155 } from "thirdweb/modules";
 *
 * const result = await SimpleMetadataERC1155.encodeBytesOnInstall({
 *  contract,
 * });
 *
 * ```
