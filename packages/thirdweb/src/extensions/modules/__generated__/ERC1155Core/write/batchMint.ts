 ...
 *
 * const supported = ERC1155Core.isBatchMintSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { ERC1155Core } from "thirdweb/modules";
 * const result = ERC1155Core.encodeBatchMintParams({
 *  to: ...,
 *  ids: ...,
 *  amounts: ...,
 *  data: ...,
 ...
 * ```ts
 * import { ERC1155Core } from "thirdweb/modules";
 * const result = ERC1155Core.encodeBatchMint({
 *  to: ...,
 *  ids: ...,
 *  amounts: ...,
 *  data: ...,
 ...
 * import { ERC1155Core } from "thirdweb/modules";
 *
 * const transaction = ERC1155Core.batchMint({
 *  contract,
 *  to: ...,
 *  ids: ...,
 *  amounts: ...,
