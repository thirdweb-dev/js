 ...
 *
 * const supported = DelayedRevealBatchMetadataERC721.isUploadMetadataSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { DelayedRevealBatchMetadataERC721 } from "thirdweb/modules";
 * const result = DelayedRevealBatchMetadataERC721.encodeUploadMetadataParams({
 *  amount: ...,
 *  baseURI: ...,
 *  data: ...,
 * });
 ...
 * ```ts
 * import { DelayedRevealBatchMetadataERC721 } from "thirdweb/modules";
 * const result = DelayedRevealBatchMetadataERC721.encodeUploadMetadata({
 *  amount: ...,
 *  baseURI: ...,
 *  data: ...,
 * });
 ...
 * import { DelayedRevealBatchMetadataERC721 } from "thirdweb/modules";
 *
 * const transaction = DelayedRevealBatchMetadataERC721.uploadMetadata({
 *  contract,
 *  amount: ...,
 *  baseURI: ...,
 *  data: ...,
