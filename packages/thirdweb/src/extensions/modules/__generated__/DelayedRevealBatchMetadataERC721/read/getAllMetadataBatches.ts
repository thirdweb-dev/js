 ...
 * const supported = DelayedRevealBatchMetadataERC721.isGetAllMetadataBatchesSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { DelayedRevealBatchMetadataERC721 } from "thirdweb/modules";
 * const result = DelayedRevealBatchMetadataERC721.decodeGetAllMetadataBatchesResultResult("...");
 * ```
 */
 ...
 * import { DelayedRevealBatchMetadataERC721 } from "thirdweb/modules";
 *
 * const result = await DelayedRevealBatchMetadataERC721.getAllMetadataBatches({
 *  contract,
 * });
 *
 * ```
