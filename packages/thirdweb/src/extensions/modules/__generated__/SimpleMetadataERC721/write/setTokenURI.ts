 ...
 *
 * const supported = SimpleMetadataERC721.isSetTokenURISupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { SimpleMetadataERC721 } from "thirdweb/modules";
 * const result = SimpleMetadataERC721.encodeSetTokenURIParams({
 *  id: ...,
 *  uri: ...,
 * });
 * ```
 ...
 * ```ts
 * import { SimpleMetadataERC721 } from "thirdweb/modules";
 * const result = SimpleMetadataERC721.encodeSetTokenURI({
 *  id: ...,
 *  uri: ...,
 * });
 * ```
 ...
 * import { SimpleMetadataERC721 } from "thirdweb/modules";
 *
 * const transaction = SimpleMetadataERC721.setTokenURI({
 *  contract,
 *  id: ...,
 *  uri: ...,
 *  overrides: {
