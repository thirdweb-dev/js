 ...
 * @example
 * ```ts
 * import { isStakingTokenSupported } from "thirdweb/extensions/erc721";
 *
 ...
 * @example
 * ```ts
 * import { decodeStakingTokenResult } from "thirdweb/extensions/erc721";
 ...
 * @example
 * ```ts
 * import { stakingToken } from "thirdweb/extensions/erc721";
 *
