 ...
 * @example
 * ```ts
 * import { isGetSupplyClaimedByWalletSupported } from "thirdweb/extensions/erc20";
 *
 ...
 * @example
 * ```ts
 * import { encodeGetSupplyClaimedByWalletParams } "thirdweb/extensions/erc20";
 ...
 * @example
 * ```ts
 * import { encodeGetSupplyClaimedByWallet } "thirdweb/extensions/erc20";
 ...
 * @example
 * ```ts
 * import { decodeGetSupplyClaimedByWalletResult } from "thirdweb/extensions/erc20";
 ...
 * @example
 * ```ts
 * import { getSupplyClaimedByWallet } from "thirdweb/extensions/erc20";
 *
