 ...
 * @example
 * ```ts
 * import { isSellSupported } from "thirdweb/extensions/tokens";
 *
 ...
 * @example
 * ```ts
 * import { encodeSellParams } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodeSell } from "thirdweb/extensions/tokens";
 ...
 * import { sell } from "thirdweb/extensions/tokens";
 *
