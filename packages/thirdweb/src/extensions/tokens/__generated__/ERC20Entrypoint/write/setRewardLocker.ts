 ...
 * @example
 * ```ts
 * import { isSetRewardLockerSupported } from "thirdweb/extensions/tokens";
 *
 ...
 * @example
 * ```ts
 * import { encodeSetRewardLockerParams } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodeSetRewardLocker } from "thirdweb/extensions/tokens";
 ...
 * import { setRewardLocker } from "thirdweb/extensions/tokens";
 *
