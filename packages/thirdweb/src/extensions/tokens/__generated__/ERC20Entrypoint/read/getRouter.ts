 ...
 * @example
 * ```ts
 * import { isGetRouterSupported } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { decodeGetRouterResult } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { getRouter } from "thirdweb/extensions/tokens";
 *
