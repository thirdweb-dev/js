 ...
 * @example
 * ```ts
 * import { isPositionsSupported } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodePositionsParams } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodePositions } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { decodePositionsResult } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { positions } from "thirdweb/extensions/tokens";
 *
