 ...
 * @returns A promise that resolves to a boolean indicating if the `setTransferableFor` method is supported.
 * @extension MODULAR
 * @example
 * ```ts
 * import { isSetTransferableForSupported } from "thirdweb/extensions/modular";
 *
 * const supported = await isSetTransferableForSupported(contract);
 * ```
 */
export async function isSetTransferableForSupported(
 ...
 * @example
 * ```ts
 * import { encodeSetTransferableForParams } "thirdweb/extensions/modular";
 * const result = encodeSetTransferableForParams({
 *  target: ...,
 *  enableTransfer: ...,
 * });
 * ```
 ...
 * @example
 * ```ts
 * import { encodeSetTransferableFor } "thirdweb/extensions/modular";
 * const result = encodeSetTransferableFor({
 *  target: ...,
 *  enableTransfer: ...,
 * });
 * ```
 ...
 * @example
 * ```ts
 * import { setTransferableFor } from "thirdweb/extensions/modular";
 *
 * const transaction = setTransferableFor({
 *  contract,
 *  target: ...,
 *  enableTransfer: ...,
 *  overrides: {
