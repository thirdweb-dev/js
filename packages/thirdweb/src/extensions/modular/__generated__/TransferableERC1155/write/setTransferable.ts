 ...
 * @returns A promise that resolves to a boolean indicating if the `setTransferable` method is supported.
 * @extension MODULAR
 * @example
 * ```ts
 * import { isSetTransferableSupported } from "thirdweb/extensions/modular";
 *
 * const supported = await isSetTransferableSupported(contract);
 * ```
 */
export async function isSetTransferableSupported(
 ...
 * @example
 * ```ts
 * import { encodeSetTransferableParams } "thirdweb/extensions/modular";
 * const result = encodeSetTransferableParams({
 *  enableTransfer: ...,
 * });
 * ```
 */
 ...
 * @example
 * ```ts
 * import { encodeSetTransferable } "thirdweb/extensions/modular";
 * const result = encodeSetTransferable({
 *  enableTransfer: ...,
 * });
 * ```
 */
 ...
 * @example
 * ```ts
 * import { setTransferable } from "thirdweb/extensions/modular";
 *
 * const transaction = setTransferable({
 *  contract,
 *  enableTransfer: ...,
 *  overrides: {
 *    ...
