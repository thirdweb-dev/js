 ...
 */
export type ListingAddedFilters = {
 ...
 * import { listingAddedEvent } from "thirdweb/extensions/IMarketplace";
 *
 ...
 * ```
 */
export function listingAddedEvent(filters: ListingAddedFilters = {}) {
  return prepareEvent({
    signature:
