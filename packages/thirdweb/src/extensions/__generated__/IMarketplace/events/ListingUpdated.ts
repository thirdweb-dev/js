 ...
 */
export type ListingUpdatedFilters = {
 ...
 * import { listingUpdatedEvent } from "thirdweb/extensions/IMarketplace";
 *
 ...
 * ```
 */
export function listingUpdatedEvent(filters: ListingUpdatedFilters = {}) {
  return prepareEvent({
    signature:
