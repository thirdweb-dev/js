 ...
 */
export type UpdatedTimeUnitFilters = {
 ...
 * import { updatedTimeUnitEvent } from "thirdweb/extensions/IStaking1155";
 *
 ...
 * ```
 */
export function updatedTimeUnitEvent(filters: UpdatedTimeUnitFilters = {}) {
  return prepareEvent({
    signature:
