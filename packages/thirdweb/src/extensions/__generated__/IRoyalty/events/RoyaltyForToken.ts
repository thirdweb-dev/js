 ...
 */
export type RoyaltyForTokenFilters = {
 ...
 * import { royaltyForTokenEvent } from "thirdweb/extensions/IRoyalty";
 *
 ...
 * ```
 */
export function royaltyForTokenEvent(filters: RoyaltyForTokenFilters = {}) {
  return prepareEvent({
    signature:
