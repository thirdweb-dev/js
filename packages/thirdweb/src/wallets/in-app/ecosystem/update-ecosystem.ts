...
export type UpdateEcosystemOptions = {
 ...
 *
 * @param {UpdateEcosystemOptions} options - The options required to update the wallet ecosystem.
...
export async function updateEcosystem(
  options: UpdateEcosystemOptions,
): Promise<boolean> {
