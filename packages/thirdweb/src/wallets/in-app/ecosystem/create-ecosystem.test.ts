...
import { createEcosystem } from "./create-ecosystem.js";
...
describe.sequential("createEcosystem", () => {
  it("should throw an error if secret key is missing", async () => {
    ...
    await expect(createEcosystem(options)).rejects.toThrow(
  ...
  it("should create a wallet ecosystem successfully", async () => {
    ...
    const result = await createEcosystem(options);
