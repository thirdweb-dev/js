import type { AppMetadata, WalletMetadata } from "../types.js";
...
export type WalletConnectCreationOptions = {
  /**
   * When creating a wallet, it contains a `metadata` property that has various information about the wallet such as `id`, `name`, `iconUrl`.
