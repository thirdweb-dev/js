...
/**
 * Internal function to get the personal account for a smart wallet when it's not exposed upstream on creation.
 * @internal
 */
export function getAdminAccountForSmartAccount(
  account: Account,
): Account | undefined {
  return smartAccountToAdminAccountMap.get(account);
}
