...
- [ ] For all the commonly used components re-used 5 times or more, create an storybook for it under src/stories with dummy data, each component should have a dark and light theme story variant
