...
} from "../../extensions/modular/write/installPublishedModule.js";
export {
  uninstallPublishedModule,
  type UninstallPublishedModuleOptions,
} from "../../extensions/modular/write/uninstallPublishedModule.js";
export {
  uninstallModuleByProxy,
  type UninstallModuleByProxyOptions,
} from "../../extensions/modular/write/uninstallModuleByProxy.js";
