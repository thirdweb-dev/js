...
describe("NFT Contract", async () => {
  ...
  //   const idsPage1 = await nftContract.getOwnedTokenIds(adminWallet, {
  //     count: 2,
  //     start: 0,
  //   });
  //   expect(idsPage1).to.be.an("array").length(2);
  //   const idsPage2 = await nftContract.getOwnedTokenIds(adminWallet, {
  //     count: 5,
  //     start: 1,
  //   });
  ...
  //   // Test: getOwned()
  //   const nftPage1 = await nftContract.getOwned(adminWallet, {
  //     count: 2,
  //     start: 0,
  //   });
  //   expect(nftPage1).to.be.an("array").length(2);
  //   const nftPage2 = await nftContract.getOwned(adminWallet, {
  //     count: 5,
  //     start: 1,
  //   });
