 ...
 * @internal
 */
export const PackRewardsSchema = /* @__PURE__ */ z.object({
 ...
 * @internal
 */
export const PackRewardsOutputSchema = /* @__PURE__ */ z.object({
 ...
 * @internal
 */
export const PackMetadataInputSchema =
  /* @__PURE__ */ PackRewardsOutputSchema.extend({
