...
import type { LoyaltyCard as LoyaltyCardContract } from "@thirdweb-dev/contracts-js";
 ...
 * @public
 */
export class LoyaltyCard extends StandardErc721<LoyaltyCardContract> {
  static contractRoles = NFT_BASE_CONTRACT_ROLES;

  public abi: Abi;
  public metadata: ContractMetadata<
    LoyaltyCardContract,
    typeof LoyaltyCardContractSchema
  >;

  public app: ContractAppURI<LoyaltyCardContract>;
  public roles: ContractRoles<
    LoyaltyCardContract,
    (typeof LoyaltyCard.contractRoles)[number]
  >;
  public encoder: ContractEncoder<LoyaltyCardContract>;
  public estimator: GasCostEstimator<LoyaltyCardContract>;
  public events: ContractEvents<LoyaltyCardContract>;
  public sales: ContractPrimarySale<LoyaltyCardContract>;
  public platformFees: ContractPlatformFee<LoyaltyCardContract>;
  /**
   * Configure royalties
  ...
  public royalties: ContractRoyalty<
    ...
    typeof LoyaltyCardContractSchema
  >;
  public owner: ContractOwner<LoyaltyCardContract>;
   ...
   * @internal
   */
  public interceptor: ContractInterceptor<LoyaltyCardContract>;
  ...
  constructor(
    ...
    abi: AbiInput,
    chainId: number,
    contractWrapper = new ContractWrapper<LoyaltyCardContract>(
      network,
      address,
      abi,
      options,
   ...
   * ```
   */
  cancel = /* @__PURE__ */ buildTransactionFunction((tokenId: BigNumberish) => {
    return this.erc721.cancel.prepare(tokenId);
  });
   ...
   * ```
   */
  revoke = /* @__PURE__ */ buildTransactionFunction((tokenId: BigNumberish) => {
    return this.erc721.revoke.prepare(tokenId);
  });
  ...
  public async prepare<
    TMethod extends keyof LoyaltyCardContract["functions"] = keyof LoyaltyCardContract["functions"],
  >(
    method: string & TMethod,
    args: any[] & Parameters<LoyaltyCardContract["functions"][TMethod]>,
  ...
  >(
    ...
    args?: Parameters<LoyaltyCardContract["functions"][TMethod]>,
    overrides?: CallOverrides,
  ): Promise<ReturnType<LoyaltyCardContract["functions"][TMethod]>> {
