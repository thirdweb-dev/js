 ...
 */
export type ApiEngineError = EngineError;
...
export type EncodeResponse = {
	 ...
	 */
	result: EncodeResults;
};

/**
 * Failed result from a contract encode operation
 */
export type EncodeResultFailureItem = {
	/**
 ...
 */
export type EncodeResultItem =
	| EncodeResultSuccessItem
	| EncodeResultFailureItem;
 ...
 */
export type EncodeResults = {
	/**
	 * Array of results, one for each input contract call
	 */
	results: Array<EncodeResultItem>;
};
 ...
 */
export type ReadResultFailureItem = {
	/**
	 * Detailed error information describing what went wrong
	 *
 ...
 */
export type ReadResultItem = ReadResultSuccessItem | ReadResultFailureItem;

/**
 * Successful result from a contract read operation
 */
export type ReadResultSuccessItem = {
	/**
 ...
 * Configuration options for signing
 */
export type SignOptions = SigningOptions;
 ...
 */
export type SignResultFailureItem = {
	/**
	 * Detailed error information describing what went wrong
	 */
	error: EngineError;
 ...
 */
export type SignResultItem = SignResultSuccessItem | SignResultFailureItem;

/**
 * Successful result from a typed data signing operation
 */
export type SignResultSuccessItem = {
	/**
 ...
 */
export type SignResults = {
	/**
	 * Array of results, one for each input typed data
	 */
	results: Array<SignResultItem>;
};
 ...
 */
export type SmartAccountSigningOptions =
...
export type ThirdwebError =
	...
	| {
			HttpError: SerializableReqwestError;
	  };
...
export type TypedDataDomainDef = {
	 ...
	 */
	salt?: string | null;
	verifying_contract?: null | AddressDef;
	/**
...
export type WriteTransactionResponses = {
	/**
...
export type WriteTransactionResponse =
	WriteTransactionResponses[keyof WriteTransactionResponses];
...
export type SignMessageResponse2 =
...
export type SignTypedDataResponses = {
	 ...
	 */
	200: SignTypedDataResponse;
};

export type SignTypedDataResponse2 =
