...
import { getInjectedBinanceProvider } from "./getInjectedBinanceProvider";

export type BinanceConnectorOptions = InjectedConnectorOptions;

type BinanceConnectorConstructorArg = {
  chains?: Chain[];
  connectorStorage: AsyncStorage;
  options?: BinanceConnectorOptions;
};

export class BinanceConnector extends InjectedConnector {
  readonly id = walletIds.binance;

  constructor(arg: BinanceConnectorConstructorArg) {
    const defaultOptions = {
      name: "Binance",
      shimDisconnect: true,
      shimChainChangedDisconnect: true,
      getProvider: getInjectedBinanceProvider,
    };
  ...
  /**
   * Connect to injected Binance Wallet provider
   */
