...
export class SignerConnection extends IJsonRpcConnection {
  ...
  private opts: IWCEthRpcConnectionOptionsWithSession | undefined;
  ...
  public async sendAsync(payload: any) {
    // noop
  ...
  private register(opts?: IWCEthRpcConnectionOptionsWithSession): IConnector {
    if (this.wc) {
      return this.wc;
    }
