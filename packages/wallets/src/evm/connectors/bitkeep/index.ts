...
type BitKeepConnectorConstructorArg = {
  chains?: Chain[];
...
export class BitKeepConnector extends InjectedConnector {
    ...
    const defaultOptions = {
      ...
      getProvider() {
        ...
        if (assertWindowEthereum(globalThis.window)) {
          ...
          return getReady(globalThis.window?.bitkeep?.ethereum);
        }
      },
    };
  ...
  /**
   * Connect to injected BitKeep provider
   */
