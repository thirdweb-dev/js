...
describe("Airdrop ERC721", async () => {
  ...
  beforeEach(async () => {
    ...
    const implementation = await deployContractAndUploadMetadata(Airdrop__factory.abi, Airdrop__factory.bytecode, adminWallet);
    const airdropContractAddress = await sdk.deployer.deployProxy(implementation, Airdrop__factory.abi, "initialize", [adminWallet.address]);
  ...
  describe("Drop", () => {
    ...
    it("should perform airdrop of ERC721 tokens", async () => {
      await airdropContract.airdrop.dropERC721(
    ...
    it("should perform airdrop of ERC1155 tokens", async () => {
      await airdropContract.airdrop.dropERC1155(
