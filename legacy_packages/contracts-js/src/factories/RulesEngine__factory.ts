...
import type { RulesEngine, RulesEngineInterface } from "../RulesEngine";
...
export class RulesEngine__factory {
  ...
  static createInterface(): RulesEngineInterface {
    return new utils.Interface(_abi) as RulesEngineInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RulesEngine {
    return new Contract(address, _abi, signerOrProvider) as RulesEngine;
  }
}
