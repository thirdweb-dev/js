      ...
      <div className="mb-4 flex items-center justify-between gap-6 ">
        <div>
          ...
          <p className="mt-0.5 text-muted-foreground text-xs">
            Configure which operations are allowed for this partner
          </p>
        </div>
        <Switch
          ...
          >
            <div className="flex flex-1 flex-col gap-2">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Chain ID (optional)</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        placeholder="1"
...
function PersonalSignRestrictions({
  ...
  return (
    <div className="mt-4">
      <Label className="mb-3 inline-block">Allowed Personal Signs</Label>
      <div className="flex flex-col gap-4">
...
function UserOpTransactions({
  ...
  return (
    <div className="mt-4">
      <Label className="mb-3 inline-block">Allowed UserOp Transactions</Label>
      <div className="flex flex-col gap-4">
