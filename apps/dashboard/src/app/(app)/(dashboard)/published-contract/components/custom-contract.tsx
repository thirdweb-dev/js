...
import { AddToProjectCardUI } from "../[publisher]/[contract_id]/components/contract-deploy-form/add-to-project-card";
import { ContractDeploymentFieldset } from "../[publisher]/[contract_id]/components/contract-deploy-form/common";
import { ContractMetadataFieldset } from "../[publisher]/[contract_id]/components/contract-deploy-form/contract-metadata-fieldset";
import {
  type DeployModalStep,
  DeployStatusModal,
  useDeployStatusModal,
} from "../[publisher]/[contract_id]/components/contract-deploy-form/deploy-context-modal";
import {
...
} from "../[publisher]/[contract_id]/components/contract-deploy-form/modular-contract-default-modules-fieldset";
import { Param } from "../[publisher]/[contract_id]/components/contract-deploy-form/param";
import { PlatformFeeFieldset } from "../[publisher]/[contract_id]/components/contract-deploy-form/platform-fee-fieldset";
import { PrimarySaleFieldset } from "../[publisher]/[contract_id]/components/contract-deploy-form/primary-sale-fieldset";
import { RoyaltyFieldset } from "../[publisher]/[contract_id]/components/contract-deploy-form/royalty-fieldset";
import {
  type Recipient,
  SplitFieldset,
} from "../[publisher]/[contract_id]/components/contract-deploy-form/split-fieldset";
import { TrustedForwardersFieldset } from "../[publisher]/[contract_id]/components/contract-deploy-form/trusted-forwarders-fieldset";
        ...
        >
          {Object.keys(formDeployParams).length > 0 && (
            <>
              ...
              {/* for StakeERC721 */}
              {showRewardsSection && (
                <ContractDeploymentFieldset legend="Reward Parameters">
              ...
              {/* for Vote */}
              {showVoteSection && (
                <ContractDeploymentFieldset legend="Voting Parameters">
                  <div className="flex flex-col gap-6">
          ...
          <ContractDeploymentFieldset legend="Deploy Options">
            <div className="flex flex-col gap-6">
              {/* Chain */}
              <FormFieldSetup
                isRequired
