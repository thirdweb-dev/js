...
export default function FilterDetailsStep({
  form,
  eventSignatures,
  functionSignatures,
  fetchedAbis,
  ...
  const createAbiQueryKey = (
    ...
    addresses: string,
    type: string,
  ) => ["event-abis", addresses, chainIds, type];
            ...
            <FormItem className="flex flex-col">
              ...
              <FormControl>
                <MultiNetworkSelector
                  selectedChainIds={field.value.map(Number) || []}
                  onChange={(chainIds) => {
                    field.onChange(chainIds.map(String));
                  }}
              ...
              <FormControl>
                ...
                eventSignatures.length > 0 ? (
                      ...
                      {functionSignatures.map((func) => (
                        ...
                        >
                          <div className="flex w-full flex-col">
                            ...
                            <span className="wxs overflow-x-auto text-muted-foreground text-xs">
                  ...
                  <Input
                    ...
                    value={field.value}
                    onChange={field.onChange}
                    disabled={isFetchingEventAbi || isFetchingTxAbi}
                  />
                )}
              </FormControl>
              <FormMessage />
                  ...
                  <div className="space-y-2 rounded-md border bg-primary/5 p-3">
                    <div className="flex items-center">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          // Clear the React Query cache for the appropriate type
                          if (watchFilterType === "event") {
                            queryClient.resetQueries({
                              queryKey: createAbiQueryKey(
                                selectedChainIds,
