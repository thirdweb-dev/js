    ...
    try {
      ...
      await createSupportTicket({
        ...
        onBehalfOf: {
          ...
          name: team.name,
          userId: team.unthreadCustomerId || account.id,
        },
        plan: team.billingPlan || "pro",
          ...
          <div className="border border-[#1F1F1F] bg-[#0A0A0A] p-6 rounded-lg mb-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <Button
                  className="border-[#2663EB] bg-[#2663EB]/10 text-[#2663EB] hover:bg-[#2663EB]/20 hover:text-[#2663EB]"
                  onClick={() => {
