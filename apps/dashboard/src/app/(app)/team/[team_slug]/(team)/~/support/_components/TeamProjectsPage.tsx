...
// Fallback mock data if no tickets provided
const defaultSupportCases = [
  {
    id: "328976",
    ...
    updatedAt: "2025-02-15T10:38:00Z",
  },
  {
    id: "329042", 
...
export default function SupportCasesPage({ tickets }: SupportCasesPageProps) {
  const [selectedCaseId, setSelectedCaseId] = useState<string | null>(null);
  
  // Use provided tickets or fallback to default
  const supportCases = tickets || defaultSupportCases;
