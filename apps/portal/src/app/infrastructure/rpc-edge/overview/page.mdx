...
<Callout variant="info" title="Accessing your RPC URL">
	To use RPC Edge with other tools like Anvil, take a chain's [public RPC endpoint](https://thirdweb.com/chainlist) and attach your app's client ID from Project > Settings page in [dashboard](https://thirdweb.com/team/~/~/projects) `https://<chainId>.rpc.thirdweb.com/<clientId>`.
</Callout>
