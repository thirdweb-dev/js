...
<Tabs defaultValue="typescript">
  <TabsList>
    <TabsTrigger value="typescript" className="flex items-center">
      <TypeScriptIcon className="w-4 h-4 mr-2 mb-3" />
      TypeScript
    </TabsTrigger>
    <TabsTrigger value="react" className="flex items-center">
      <ReactIcon className="w-4 h-4 mr-2 mb-3" />
      React
    </TabsTrigger>
    <TabsTrigger value="reactnative" className="flex items-center">
      <ReactIcon className="w-4 h-4 mr-2 mb-3" />
      React Native
    </TabsTrigger>
    <TabsTrigger value="unity" className="flex items-center">
      <UnityIcon className="w-4 h-4 mr-2 mb-3" />
      Unity
    </TabsTrigger>
    <TabsTrigger value="dotnet" className="flex items-center">
      <DotNetIcon className="w-4 h-4 mr-2 mb-3" />
      .NET
    </TabsTrigger>
    <TabsTrigger value="unreal" className="flex items-center">
      <UnrealEngineIcon className="w-4 h-4 mr-2 mb-3" />
      Unreal Engine
    </TabsTrigger>
  </TabsList>
