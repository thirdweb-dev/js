...
<OpenApiEndpoint path="/v1/wallets/server" method="GET" responseExampleOverride={{
  ...
  <TabsContent value="dotnet">
    ...
    Before using a server wallet in code, create it in the [thirdweb dashboard](https://thirdweb.com/dashboard/connect/account-abstraction) (Transactions → Server wallets) and note the label you assign.
