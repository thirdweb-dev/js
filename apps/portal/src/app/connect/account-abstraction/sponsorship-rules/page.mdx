...
- **Restricciones de cadena**: Usa esto si deseas patrocinar transacciones solo en ciertas cadenas. Si esto no se configura, las transacciones en todas las [cadenas soportadas](https://portal.thirdweb.com/wallets/account-abstraction/infrastructure#supported-chains) serán patrocinadas.
