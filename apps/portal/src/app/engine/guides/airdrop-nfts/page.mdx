...
Usa el componente [`ConnectButton`](/references/typescript/v5/ConnectButton) para solicitar la billetera del usuario. El botón **Claim** para llamar `POST /api/claim`.
