...
Usa [`<ConnectButton>`](/references/typescript/v5/ConnectButton) para solicitar al comprador su dirección de billetera. El comprador ingresa los detalles de su tarjeta de crédito y selecciona **Pagar ahora** para enviar los detalles de pago directamente a Stripe.
