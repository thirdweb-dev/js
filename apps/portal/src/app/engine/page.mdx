...
🚀 [Get Engine hosted by thirdweb](https://thirdweb.com/dashboard/engine/create) or [self-host for free](/engine/self-host).
...
Cloud-hosting Engine with thirdweb starts at $99 per month. Learn more about [Engine pricing](https://thirdweb.com/dashboard/engine/create).
