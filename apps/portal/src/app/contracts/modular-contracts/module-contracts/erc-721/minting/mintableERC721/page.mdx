...
The `MintableERC721` contract is a module that provides minting functionalities for ERC-721 tokens. This module includes features such as minting with and without signatures, and configuration for primary sales recipients.
...
|-----------------------------------|----------------------------------------------------------------------------------------------------------------|
| `beforeMintERC721`                | Callback function that checks the mint authorization before minting ERC-721 tokens.                           |
| `beforeMintWithSignatureERC721`   | Callback function that verifies a minting request with a signature and processes the mint accordingly.         |
