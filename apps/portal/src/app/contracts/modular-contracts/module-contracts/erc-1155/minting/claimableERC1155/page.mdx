...
|-----------------------------------|----------------------------------------------------------------------------------------------------------------|
| `beforeMintERC1155`               | Callback function that checks the claim conditions before minting ERC-1155 tokens.                              |
| `beforeMintWithSignatureERC1155`  | Callback function that verifies a claim request with a signature and processes the mint accordingly.            |
