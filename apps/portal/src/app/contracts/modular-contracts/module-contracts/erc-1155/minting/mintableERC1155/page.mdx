...
|-----------------------------------|----------------------------------------------------------------------------------------------------------------|
| `beforeMintERC1155`               | Callback function that checks the mint authorization before minting ERC-1155 tokens.                           |
| `beforeMintWithSignatureERC1155`  | Callback function that verifies a minting request with a signature and processes the mint accordingly.         |
