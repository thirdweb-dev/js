...
export const metadata = createMetadata({
	...
	description:
		"ERC1155DelayedReveal agrega la funcionalidad de Delayed Reveal al contrato base ERC1155LazyMint.",
	image: {
		title: "Contrato ERC1155DelayedReveal",
		icon: "contract",
	},
});
...
`ERC1155DelayedReveal` agrega la funcionalidad de [Delayed Reveal](/glossary/delayed-reveal) al contrato
base [ERC1155LazyMint](/contracts/build/base-contracts/erc-1155/lazy-mint).
