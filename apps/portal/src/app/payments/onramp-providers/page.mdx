...
**Onramp Providers** are services that allow users to buy crypto with fiat. You can set preferred providers for your application by using the [`preferredProvider`](/payments/customization/payembed#preferred-provider) parameter in the `PayEmbed` component.
