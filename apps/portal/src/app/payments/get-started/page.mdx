...
Learn how to integrate Payments into your application for cross-chain payments, bridging, swapping, and fiat onramps.
...
Log in to [the thirdweb dashboard](https://thirdweb.com/login) and create a new project. On project creation, you'll be given a **Client ID**. You'll need your Client ID to integrate Payments into your application.
...
- **[Webhooks](/payments/webhooks)** - Set up real-time notifications
- **[Customization Guides](/payments/customization)** - Advanced configuration options
