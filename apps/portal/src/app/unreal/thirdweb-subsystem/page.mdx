...
export const metadata = createMetadata({
    title: "ThirdwebSubsystem | Thirdweb Unreal Engine SDK",
...
It should not be used directly but through the plugin's Blueprint functions or other higher-level abstractions provided by the Thirdweb Unreal Engine SDK.
