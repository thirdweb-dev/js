...
En esta guía aprenderemos cómo usar el blueprint de eventos en Insight.

## Requisitos previos

- [Crea un proyecto](https://thirdweb.com/team) y navega a la configuración del proyecto para obtener un ID de cliente
- Usa la API de Insight con la URL base a continuación.
- Para autenticarte, usa tu ID de cliente en el encabezado `x-client-id` o en el parámetro de consulta `clientId`
...
Una vez que ejecutes la consulta anterior, recibirás un resultado similar a este:
