...
<Steps>
    ...
    ```
    <Callout variant="info" title="Client ID">Get a free client ID to use in your application by creating a project in [thirdweb's dashboard](https://thirdweb.com/team/~/~/projects).</Callout>
	</Step>
