...
<Steps>
    ...
    ```
    <Callout variant="info" title="Client ID">Get a free client ID to use in your application from [thirdweb's dashboard](https://thirdweb.com/dashboard/settings/api-keys).</Callout>
	</Step>
