...
Ecosystem wallets inherit all the functionality of [in-app wallets](/react/v5/in-app-wallet/get-started), but instead of being scoped to a single app, they can be used across multiple applications.
...
Try out ecosystem wallets for yourself in the [in-app wallet live playground](https://playground.thirdweb.com/wallets/ecosystem-wallet)
...
<ArticleIconCard
	title="Try the demo"
	icon={ExternalLink}
	href="https://playground.thirdweb.com/wallets/ecosystem-wallet"
...
Refer to the [in-app wallets](/react/v5/in-app-wallet/get-started) documentation to add your ecosystem wallet to the connect UI components or build your own UI.
