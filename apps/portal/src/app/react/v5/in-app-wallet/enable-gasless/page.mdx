...
Try out the demo for yourself in the [sponsored transactions playground](https://playground.thirdweb.com/account-abstraction/eip-4337)
...
<ArticleIconCard
	title="Try the demo"
	icon={ExternalLink}
	href="https://playground.thirdweb.com/account-abstraction/eip-4337"
