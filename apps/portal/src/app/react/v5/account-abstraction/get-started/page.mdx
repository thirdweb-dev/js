...
Try out in-app wallets for yourself in the [in-app wallet live playground](https://playground.thirdweb.com/account-abstraction)
...
<ArticleIconCard
	title="Try the demo"
	icon={ExternalLink}
	href="https://playground.thirdweb.com/account-abstraction"
