...
By default, In-App Wallet services are enabled upon creation of the API Key. You can view your in-app wallet's settings in the configuration tab of the [in-app wallet dashboard](https://thirdweb.com/dashboard/connect/in-app-wallets)
